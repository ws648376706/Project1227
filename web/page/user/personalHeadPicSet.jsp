...
<div class="main">
    ...
    <div class="right" id="r1">
        <form action="/ServletHeadPicSet" method="post" enctype="multipart/form-data">
            ...
            <div class="right_mid" id="r_1">
                <div class="webinfo">
                    ...
                    <div>
                        <input type="file" value="选择文件" id="f" name="file" style="width: auto" accept="image/jpeg">
                    </div>
                    <div class="tijiao" id="tijiao">
                        <span id="sp2">上&nbsp;&nbsp;&nbsp;传</span>
                    </div>
                    <div style="display: none">
                        <%--<input type="submit" value="缩略" id="in1">--%>
                        <input type="submit" value="上传" id="in2">
                    </div>
                </div>
            </div>
        </form>
