...
<div class="main">
    <div class="left">
        <div class="touxiang">
            ...
            <br><span></span>账号：${admin_user}
            <br><span></span>姓名：管理员大人
        </div>
        <div class="caidan">
            <ul>
                <span></span>
    ...
    <div class="right" id="r1">
        <form action="" method="post">
            ...
            <div class="right_mid" id="r_1">
                ...
                <table class="tb">
                    <th>
                    <td class="td_1">主体性质</td>
                    <td class="td_2">开办人姓名</td>
                    <td class="td_3">证件类型</td>
                    <td class="td_4">证件号码</td>
                    <td class="td_5">详情</td>
                    </th>
                </table>
                <div class="rlwz">
